...
//PR12. Loguearse, comprobar que se visualizan 4 filas de notas y desconectarse usando el rol d estudiante
    ...
    @Order(14)
    public void PR12() {
        PO_LoginView.doLogin(driver, "99999990A", "123456");

        //COmprobamos que entramos en la pagina privada de Alumno
        SeleniumUtils.textIsPresentOnPage(driver, "Notas del usuario");
       //Contamos el número de filas de notas
        PO_PrivateView.checkNumberOfMarkRows(driver, 2);
        //Ahora nos desconectamos y comprobamos que aparece el menú de registro
        PO_NavView.doLogout(driver);
    }
    ...
    public void PR13() {
        ...
        PO_PrivateView.goToDetails(driver,checkText);
...
//P14. Esta prueba podría encapsularse mejor ...
    ...
    public void PR14() {
        ...
        PO_NavView.doLogin(driver, "99999993D", "123456");
        ...
        PO_PrivateView.doAddMark(driver, 3, checkText, "8");
        SeleniumUtils.goToPage(driver,5);
        PO_PrivateView.checkMarkExists(driver, checkText);
    ...
    public void PR15() {
        ...
        PO_NavView.goToNavPage(driver, "mark/list");
        ...
        PO_PrivateView.doDeleteMark(driver, "Nota sistemas distribuidos");
